...
class Customizer_Repeater extends WP_Customize_Control {
			...
			foreach($array as $icon){ ?>
                <div class="customizer-repeater-general-control-repeater-container customizer-repeater-draggable">
                    ...
                    <div class="customizer-repeater-box-content-hidden">
						<?php
						$choice = $image_url = $icon_value = $title = $img_pos = $subtitle = $text = $text2  = $link2 = $link = $shortcode = $repeater = $color = $color2 = '';
						if(!empty($icon->id)){
							$id = $icon->id;
						}
	...
	private function img_pos_control(){ ?>
        <div class="customizer-repeater-img-pos-control">
			<span class="customize-control-title">
                <?php esc_html_e('Image position','your-textdomain')?>
            </span>
            <input type="radio" value="<?php echo "left"; ?>">
			<label for="left"><?php esc_html_e('Left','your-textdomain'); ?></label><br>

			<input type="radio" value="<?php echo "right"; ?>" >
			<label for="right"><?php esc_html_e('Right','your-textdomain'); ?></label>
        </div>
		<?php
	}
